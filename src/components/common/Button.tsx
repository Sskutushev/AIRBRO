...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      'bg-gradient-to-r from-primary-telegram to-primary-electric text-white hover:opacity-90',
    ...
    secondary:
      'bg-white text-primary-telegram border border-primary-telegram hover:bg-primary-telegram/10',
    outline:
      'border border-text-secondary text-text-secondary hover:border-primary-telegram hover:text-primary-telegram',
    ...
    >
      {loading ? (
        <svg
          ...
          fill="none"
          viewBox="0 0 24 24"
          role="status" // Add role="status" for accessibility
        >
          <circle
