      ...
      keyBenefits: [
        {
          ...
          description:
            'Ваши клиенты всегда получат ответ, даже в нерабочее время, что повышает лояльность и доступность сервиса.',
        },
        {
          title: 'Экономия ресурсов',
          description:
            'Автоматизация рутинных запросов сокращает нагрузку на живых операторов до 70%, позволяя им сосредоточиться на сложных задачах.',
        },
        {
          title: 'Персонализация',
          description:
            'AI запоминает историю обращений каждого клиента, предлагая релевантные решения и создавая ощущение индивидуального подхода.',
        },
      ],
      howItWorks: [
      ...
      keyBenefits: [
        {
          ...
          description:
            'Исключите ручную обработку звонков и сообщений по записи, освободив время сотрудников.',
        },
        {
          title: "Снижение 'неявок'",
          description:
            'Автоматические напоминания о предстоящих встречах значительно сокращают количество пропущенных бронирований.',
        },
        {
          title: 'Увеличение заполняемости',
          description:
            'Удобный и интуитивно понятный процесс бронирования, доступный 24/7, стимулирует клиентов к записи.',
        },
      ],
      howItWorks: [
      ...
      keyBenefits: [
        {
          ...
          description:
            'Быстро выявляйте слабые места в вашем бизнесе и оперативно реагируйте на негативные отзывы.',
        },
        {
          title: 'Рост репутации',
          description:
            'Автоматически собирайте позитивные отзывы и стимулируйте их публикацию на внешних площадках.',
        },
        {
          title: 'Глубокая аналитика',
          description:
            'Получайте агрегированные отчеты NPS (Net Promoter Score) и анализ настроений клиентов в автоматическом режиме.',
        },
      ],
      howItWorks: [
