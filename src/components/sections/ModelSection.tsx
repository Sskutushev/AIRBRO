        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="text-green-600 font-bold">
                    ✓ Гарантия: Если не найдём — возврат
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-6">
            ...
            >
              <Card
                variant="glass"
                className="p-6 border-2 border-green-500 relative overflow-hidden"
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-green-600">
                      Мы не заработаем, пока вы не сэкономите
                    </span>
                  </div>
                  <div className="pt-2">
                    <div className="text-green-600 font-bold">
                      Условие: % от доказанной экономии 12-18 мес
                    </div>
                  </div>
                </div>
              </Card>
        ...
        >
          ...
          <div className="mt-8 text-center">
            <div className="text-xl">
              Пример: $17,500 экономия → $8,750 нам → $8,750 ваша чистая экономия
            </div>
          </div>
        </motion.div>
      </div>
