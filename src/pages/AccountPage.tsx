            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-primary-violet/10 to-primary-violet/5 p-5 rounded-xl">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <p className="text-text-secondary text-sm">Subscription Until</p>
                  ...
                  <div className="bg-gradient-to-br from-primary-coral/10 to-primary-coral/5 p-5 rounded-xl">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <p className="text-text-secondary text-sm">Next Payment</p>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  <h2 className="text-xl font-bold text-text-primary mb-4">Active Products</h2>
                    ...
                    <div className="flex items-center justify-between p-4 bg-bg-primary rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-text-secondary text-sm">Main product</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-text-primary">3,000 ₽/month</p>
                        <p className="text-text-secondary text-sm">Active until 05.12.2025</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-bg-primary rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-text-secondary text-sm">Horizontal product</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-text-primary">2,000 ₽/month</p>
                        <p className="text-text-secondary text-sm">Active until 05.12.2025</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                {/* Billing */}
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  <h2 className="text-lg font-bold text-text-primary mb-4">Billing Information</h2>
                  <div className="space-y-3">
