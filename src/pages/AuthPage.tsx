...
import { User, Mail, Lock, Smartphone, ArrowRight, CheckCircle, ArrowLeft, Loader2 } from 'lucide-react';
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-primary-electric to-primary-violet text-white font-bold rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center disabled:opacity-70"
              >
                {loading ? (
                  <>
